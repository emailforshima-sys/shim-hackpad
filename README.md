...
..The KMK firmware is still not completed (yet), for now the keys should work ( like ABC..). now I'm working on the code for the oled with CircuitPython
...
# BOM?
(this is also in BOM.csv with links)
